...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-3 minalogo">
               <img src="assets/images/mina-wordmark-light.svg" alt="Mina" class="mina-main-logo d-block mx-auto mx-md-0">
        </div>
        <div class="row mb-5">
            <div class="subheader">
        ...
        <div class="row mb-4">
            <div class="">
                <p class="font-weight-bold">Ranking for the Mina Foundation Uptime Leaderboard are based on data from the Sidecar Uptime System.</p>
            </div>
        </div>
                ...
                <div class="col-12 px-0 mx-0">
                    ...
                    <ul class="nav nav-pills text-uppercase text-center">
                            <li class="nav-item left-box">
                                ...
                                <div class="row">
                                <div class="col-12 px-0 mx-0 beta-text">
